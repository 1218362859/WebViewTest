...
import com.example.a.service.DownloadService;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.start_download:
                String url = "http://shouji.360tpcdn.com/180428/915e78ea3bffb9f02e80394eb8181b3e/com.qihoo360.mobilesafe_259.apk";
        ...
        switch (requestCode){
            case  1:
                if (grantResults.length>0 &&grantResults[0]!= PackageManager.PERMISSION_GRANTED){
                    Toast.makeText(this,"权限被拒绝了,无法使用程序",Toast.LENGTH_SHORT).show();
                    finish();
                }
                break;
        }
