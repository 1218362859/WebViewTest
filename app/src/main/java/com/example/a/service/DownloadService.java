...
import com.example.a.Tool.DownloadTask;
import com.example.a.webviewtest.DownloadActivity;
import com.example.a.webviewtest.DownloadListener;
import com.example.a.webviewtest.R;

import java.io.File;

//保证DownloadTask可以一直在后台运行，我们需要创建一个下载的服务
//通过new －> service 创建一个service 这样就可以自动去清单文件注册了
